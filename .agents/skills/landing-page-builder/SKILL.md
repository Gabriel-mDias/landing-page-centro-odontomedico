...
5. **Propor a direção criativa.** Leia [references/strategy-creative-direction.md](references/strategy-creative-direction.md). Copie `requisitos/direcao-criativa-template.md` para `requisitos/direcao-criativa.md` e complete narrativa, mapa de seções, hero, paleta, tipografia, repertório verbal, referências, assets e restrições. Marque toda proposta nova como `inferido`.
...
8. **Validar.** Leia [references/quality-gates.md](references/quality-gates.md). Execute `npm test`, `npm run validate:publication` e o smoke test em 390, 768 e 1440 px. Um gate de publicação recusado é bloqueador, não um aviso.
